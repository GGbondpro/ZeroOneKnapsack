...
- [2 回溯法的时间复杂度验证](#2-回溯法的时间复杂度验证)
  ...
  - [2.3 作出算法在三种相关性数据下的对比图（三条曲线，z-n）](#23-作出算法在三种相关性数据下的对比图三条曲线z-n)
...
曲线说明：t-n,t的单位毫秒；z=log2(t),z-n，t的单位为微秒<br>
...
##### 2.3 作出算法在三种相关性数据下的对比图（三条曲线，z-n）<br>
实验数据:<br>
...
***
**注意：**
1.以上的图像中，不是取对数的t，其单位都是毫秒，取对数的t，其单位是微秒。
